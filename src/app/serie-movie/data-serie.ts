...
export const dataSeries: Serie[] = [
  new Serie(
    ...
    'Netflix',
    5,
    'Los Bridgerton es una serie que cuenta desde una perspectiva feminista una historia de amor durante el Período de Regencia en el Reino Unido.',
    'https://cdn.forbes.com.mx/2021/02/BRIDGERTON-Netflix-serie.jpg'
  ),
